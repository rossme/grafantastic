...
RSpec.describe Diffdash::AST::AncestorResolver do
  ...
  describe '#collect_ancestors' do
    ...
    it 'collects parent class' do
      ...
      ast = Diffdash::AST::Parser.parse(child_source, child_file)
      visitor = Diffdash::AST::Visitor.new(file_path: child_file, inheritance_depth: 0)
      visitor.process(ast)
    ...
    it 'collects included modules' do
      ...
      ast = Diffdash::AST::Parser.parse(class_source, class_file)
      visitor = Diffdash::AST::Visitor.new(file_path: class_file, inheritance_depth: 0)
      visitor.process(ast)
