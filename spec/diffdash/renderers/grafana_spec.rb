  ...
  describe '#render' do
    ...
    context 'Getting Started panel with PR links' do
      ...
      it 'includes PR link with number when GITHUB_PR_NUMBER is set' do
        ...
        expect(getting_started[:options][:content]).to eq('🐙 Dashboard generated by diffdash — [PR#42](https://github.com/rossme/diffdash-test-app/pull/42)')
      ...
      it 'extracts PR number from GITHUB_REF' do
        ...
        expect(getting_started[:options][:content]).to eq('🐙 Dashboard generated by diffdash — [PR#123](https://github.com/rossme/diffdash-test-app/pull/123)')
      ...
      it 'links to /pulls when in CI without PR number' do
        ...
        expect(getting_started[:options][:content]).to eq('🐙 Dashboard generated by diffdash — [View PR](https://github.com/rossme/diffdash-test-app/pulls)')
      ...
      it 'links to branch tree when running locally' do
        ...
        expect(getting_started[:options][:content]).to eq('🐙 Dashboard generated by diffdash — [View PR](https://github.com/rossme/diffdash-test-app/tree/feature/test-branch)')
      end
      ...
      it 'handles HTTPS git URLs' do
        ...
        expect(getting_started[:options][:content]).to eq('🐙 Dashboard generated by diffdash — [PR#99](https://github.com/rossme/diffdash-test-app/pull/99)')
