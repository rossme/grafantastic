  ...
  describe "#render" do
    ...
    context "with log signals" do
      ...
      it "includes getting started guidance panel" do
        ...
        expect(text_panels.first[:options][:content]).to include("Dashboard generated by diffdash")
      end
    ...
    context "Getting Started panel with PR links" do
      ...
      it "includes PR link with number when GITHUB_PR_NUMBER is set" do
        ...
        expect(getting_started[:options][:content]).to eq("Dashboard generated by diffdash 🐙 **diffdash-test-app** [PR#42](https://github.com/rossme/diffdash-test-app/pull/42)")
      ...
      it "extracts PR number from GITHUB_REF" do
        ...
        expect(getting_started[:options][:content]).to eq("Dashboard generated by diffdash 🐙 **diffdash-test-app** [PR#123](https://github.com/rossme/diffdash-test-app/pull/123)")
      ...
      it "links to /pulls when in CI without PR number" do
        ...
        expect(getting_started[:options][:content]).to eq("Dashboard generated by diffdash 🐙 **diffdash-test-app** [View PR](https://github.com/rossme/diffdash-test-app/pulls)")
      ...
      it "links to branch tree when running locally" do
        ...
        expect(getting_started[:options][:content]).to eq("Dashboard generated by diffdash 🐙 **diffdash-test-app** [View PR](https://github.com/rossme/diffdash-test-app/tree/feature/test-branch)")
      end
      ...
      it "handles HTTPS git URLs" do
        ...
        expect(getting_started[:options][:content]).to eq("Dashboard generated by diffdash 🐙 **diffdash-test-app** [PR#99](https://github.com/rossme/diffdash-test-app/pull/99)")
      ...
      it "does not include PR link when git remote is unavailable" do
        ...
        expect(getting_started[:options][:content]).to eq("Dashboard generated by diffdash")
      end
    end
  end
end
