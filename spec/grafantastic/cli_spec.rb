...
RSpec.describe Grafantastic::CLI do
  let(:git_context) { instance_double(Grafantastic::GitContext) }

  before do
    allow(Grafantastic::GitContext).to receive(:new).and_return(git_context)
