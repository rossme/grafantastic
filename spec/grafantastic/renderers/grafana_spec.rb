...
RSpec.describe Grafantastic::Renderers::Grafana do
  describe "#render" do
    context "with empty signals" do
      ...
      it "includes auto-generated message" do
        result = renderer.render
        expect(result[:message]).to eq("Auto-generated by grafantastic gem")
      end
    end
    ...
    context "with counter signals" do
      let(:counter_signal) do
        Grafantastic::Signal::Counter.new(
          name: "requests_total",
    ...
    context "with histogram signals" do
      let(:histogram_signal) do
        Grafantastic::Signal::Histogram.new(
    ...
    context "dashboard metadata" do
      ...
      it "includes Grafana tags" do
        ...
        expect(tags).to include("grafantastic")
      end
