...
RSpec.describe Grafantastic::Detectors::RubyDetector do
  ...
  describe "#detect" do
    it "detects log signals from Ruby source" do
      ...
      expect(signals.first).to be_a(Grafantastic::Signal::Log)
    ...
    it "detects metric signals from Ruby source" do
      ...
      expect(signals).not_to be_empty
      expect(signals.first).to be_a(Grafantastic::Signal::Counter)
