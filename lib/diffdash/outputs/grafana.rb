    ...
    class Grafana < Base
      ...
      def getting_started_panel(panel_id, signal_bundle)
        ...
        content = if pr_link && pr_number
                    "🐙 Dashboard generated by diffdash — [PR##{pr_number}](#{pr_link})"
                  elsif pr_link
                    "🐙 Dashboard generated by diffdash — [View PR](#{pr_link})"
                  else
                    '🐙 Dashboard generated by diffdash'
                  end
      ...
      def extract_pr_number
        ENV['GITHUB_PR_NUMBER'] ||
          ENV['GITHUB_REF']&.match(%r{refs/pull/(\d+)/merge})&.[](1)
      end
