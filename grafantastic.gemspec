...
require_relative "lib/grafantastic/version"

Gem::Specification.new do |spec|
  spec.name          = "grafantastic"
  spec.version       = Grafantastic::VERSION
  ...
  spec.homepage      = "https://github.com/rossme/grafantastic"
  spec.license       = "MIT"
  spec.required_ruby_version = ">= 3.0.0"

  spec.files = Dir.glob("{bin,lib}/**/*") + %w[README.md]
  spec.bindir        = "bin"
  spec.executables   = ["grafantastic"]
